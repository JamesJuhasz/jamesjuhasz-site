/*
  ...
  Remove from production navigation before Day 8 deploy.
  Day 1 review surface for the entire primitive set.
*/
...
const swatches = [
  { name: "navy", hex: "#0E2240" },
  { name: "navy-deep", hex: "#061122" },
  { name: "navy-soft", hex: "#1F365A" },
  { name: "foam", hex: "#F6F2EA" },
  { name: "foam-deep", hex: "#EAE3D5" },
  { name: "sand", hex: "#D8C4A6" },
  { name: "sand-warm", hex: "#B89878" },
  { name: "donate", hex: "#E04E2A" },
  { name: "donate-hover", hex: "#C53C1B" },
  { name: "ink", hex: "#0A1628" },
  { name: "mist", hex: "#6F7B8E" },
];
  ...
  return (
    <div className="py-section-y">
      <Container width="wide">
        ...
        <h1 className="mt-4 text-display font-serif text-navy">
          Design System
        </h1>
        ...
        <section className="mt-section-y-lg">
          <SectionHeader
            eyebrow="01"
            title="Color"
            lede="Palette derived from sailing photography. Single high-contrast donate accent for conversion."
          />
          <div className="mt-8 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
            {swatches.map((s) => (
              <div
                key={s.name}
                className="rounded-2xl ring-1 ring-line overflow-hidden bg-white"
              >
                <div
                  className="h-20"
                ...
                />
                <div className="p-3">
                  <p className="text-body font-medium text-navy">{s.name}</p>
                  <p className="text-caption text-mist">{s.hex}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <section className="mt-section-y-lg">
          <SectionHeader
            eyebrow="02"
            title="Typography"
            lede="Fraunces (serif headlines) paired with Inter (clean grotesque body). Editorial × athletic."
          />
          <div className="mt-8 space-y-6">
            <div>
              <p className="text-eyebrow uppercase text-mist mb-1">display</p>
              <p className="text-display font-serif text-navy">
                Chasing Olympic gold.
              </p>
            </div>
            <div>
              <p className="text-eyebrow uppercase text-mist mb-1">h1</p>
              <h1 className="text-h1">Help me get to LA 2028.</h1>
            </div>
            <div>
              <p className="text-eyebrow uppercase text-mist mb-1">h2</p>
              <h2 className="text-h2">The campaign trail.</h2>
            </div>
            <div>
              <p className="text-eyebrow uppercase text-mist mb-1">h3</p>
              <h3 className="text-h3">Recent results.</h3>
            </div>
            <div>
              <p className="text-eyebrow uppercase text-mist mb-1">body-lg</p>
            ...
            <div>
              <p className="text-eyebrow uppercase text-mist mb-1">body</p>
            ...
            <div>
              <p className="text-eyebrow uppercase text-mist mb-1">caption</p>
              <p className="text-caption text-mist">
                Photo: training camp, Mallorca — March 2026.
              </p>
            </div>
            <div>
              <p className="text-eyebrow uppercase text-mist mb-1">eyebrow</p>
        ...
        <section className="mt-section-y-lg">
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-3">
            <Card>
              <h4 className="font-serif text-h3">Default card</h4>
            ...
            <Card tone="muted">
              <h4 className="font-serif text-h3">Muted card</h4>
              <p className="mt-2 text-body text-ink/75">
            ...
            <Card tone="navy">
              <h4 className="font-serif text-h3 text-foam">Navy card</h4>
              <p className="mt-2 text-body text-foam/80">
