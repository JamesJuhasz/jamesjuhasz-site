...
export function CareerTimeline() {
  return (
    <ol className="relative grid gap-10">
      <span
        aria-hidden
        className="absolute left-4 md:left-1/2 top-2 bottom-2 w-px bg-line md:-translate-x-1/2"
      />
      {careerTimeline.map((item, i) => {
        ...
        return (
          ...
          >
            <span
              aria-hidden
              className="md:col-start-7 md:-translate-x-1/2 mt-1 md:mt-2 inline-flex h-3 w-3 rounded-full bg-donate ring-4 ring-foam"
            />
            <Reveal>
              <div
              ...
              >
                ...
                <h3 className="font-serif text-h3 text-navy">{item.title}</h3>
